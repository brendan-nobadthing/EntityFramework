...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class CoreStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.CoreStrings", typeof(CoreStrings).GetTypeInfo().Assembly);
        ...
        /// <summary>
        /// Principal and dependent side cannot be determined for one to one relationship between entity types '{declaringEntityType}' and '{principalEntityType}' involving navigations - '{dependentToPrincipalNavigation}' and '{principalToDependentNavigation}'.
        /// </summary>
        public static string AmbiguousOneToOneRelationship([CanBeNull] object declaringEntityType, [CanBeNull] object principalEntityType, [CanBeNull] object dependentToPrincipalNavigation, [CanBeNull] object principalToDependentNavigation)
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("AmbiguousOneToOneRelationship", "declaringEntityType", "principalEntityType", "dependentToPrincipalNavigation", "principalToDependentNavigation"), declaringEntityType, principalEntityType, dependentToPrincipalNavigation, principalToDependentNavigation);
        }
